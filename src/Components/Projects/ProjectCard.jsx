        ...
        <div className='relative flex md:gap-4 backdrop-blur-sm'>
            <div className='relative md:w-[210px] w-[150px] flex flex-col justify-center items-center shadow-md shadow-gray-950 md:gap-5 gap-1'>
                ...
                <div className='flex flex-col justify-center items-center'>
                    <img className=' md:w-[210px] md:h-[210px] sm:w-[150px] sm:h-[150px] w-[150px] h-[150px] object-cover hover:cursor-pointer transition-all hover:border-2 border-white ease-in duration-200 shadow-md shadow-gray-950' src={ProjectImage} alt="" />
                </div>
                <div className='w-full flex flex-col justify-center items-center sm:gap-2 gap-1 mb-2'>
                    <p className='text-[#ff0f5b] mx-1'>Project Name</p>
