  ...
  return (
    <>
      <div className="w-full gap-4 bg-[#8aaaee] text-white">
        <div className="w-full px-4 flex justify-between shadow-md shadow-gray-900">
          ...
          <div className="hidden md:flex">
            <ul className="flex justify-center items-center gap-4 p-4 font-bold">
              ...
              {user ? (
                <li
                  className="hover:text-gray-800 cursor-pointer hover:transition-all duration-200 hover:shadow-md hover:bg-[#8aaaee] hover:shadow-gray-950 rounded-md"
                  onClick={() => logout()}
                >
                  Logout
                </li>
              ...
              {user ? (
                <li className="hidden hover:text-gray-800 cursor-pointer hover:transition-all duration-200 hover:shadow-md hover:bg-[#8aaaee] hover:shadow-gray-950 rounded-md">
        ...
        <div
          className={`md:hidden absolute flex bg-[#8aaaee] max-w-full h-auto ${
            toggle ? "mx-[-100%]" : "mx-[0%]"
          }  text-white mt-4 z-10`}
        >
          <ul className="flex flex-col items-center gap-4 p-4 font-bold">
            <li
              className={`hover:text-[#88ccee] hover:text-lg hover:transition-all duration-200 cursor-pointer`}
